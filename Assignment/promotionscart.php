...
if(isset($largePizzaQty) && $largePizzaQty > 0)
{
    ...
    $subtotal = $_SESSION['cart']['largepizzatotal'] + $largePizzaQty * $_SESSION['prices'][8];
...
if(isset($familyPizzaQty) && $familyPizzaQty > 0)
{
    ...
    $subtotal = $_SESSION['cart']['familypizzatotal'] + $familyPizzaQty * $_SESSION['prices'][9];
...
if(isset($kidsPizzaQty) && $kidsPizzaQty > 0)
{
    ...
    $subtotal = $_SESSION['cart']['kidspizzatotal'] + $kidsPizzaQty * $_SESSION['prices'][10];
