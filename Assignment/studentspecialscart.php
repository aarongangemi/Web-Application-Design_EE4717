...
if($margheritaQty > 0 && isset($margheritaQty))
{
    ...
    $subtotal = $_SESSION['cart']['margheritatotal'] + $margheritaQty * $_SESSION['prices'][3];
...
if($hawaiianQty > 0 && isset($hawaiianQty))
{
    ...
    $subtotal = $_SESSION['cart']['hawaiiantotal'] + $hawaiianQty * $_SESSION['prices'][4];
...
if($pestoQty > 0 && isset($pestoQty))
{
    ...
    $subtotal = $_SESSION['cart']['pestototal'] + $pestoQty * $_SESSION['prices'][5];
